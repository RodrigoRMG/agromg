  ...
  fjs.parentNode.insertBefore(js, fjs);
    ...
    <!-- Start Top Navigation -->
            ...
            <div class="container">
                ...
                <h1 class=" portfolio_big_title">Servicios</h1>
            </div>
        </div>
        ...
        <section class="layout-fullsize items-layout-boxed" style="background:#fff;">
            <div class="container" style="background-color:#EDEDED; ">
                ...
                <div class="row-fluid">
                    <section id="portfolio-preview-items" class="two-cols span12" data-nr="2">
                        <div class="row">
                            <!-- Portfolio Normal Mode -->
                            <!-- item -->
                            <center>
                            @foreach($servicios as $servicio)
                            <div class="portfolio-item " align="center" style="margin-left:60px;">
                                <div class="he-wrap tpl2">
                                    <a href="{{url('verServicio/'.$servicio->idservicio)}}"><center><img src="{{$servicio->imagen}}" alt="" ><center><div class="overlay he-view">
                                        <div class="bg a0" >
                                            <div class="center-bar v1">
                                                <p class="title a1 lightbox-gallery lightbox" data-animate="fadeInUp">{{$servicio->nombre}}</p>
                                ...
                                <div class="info">
                                    <h4><a href="{{url('verServicio/'.$servicio->idservicio)}}">{{$servicio->nombre}}</a></h4>

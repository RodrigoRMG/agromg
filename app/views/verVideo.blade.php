        ...
        <div class="top_wrapper   no-transparent">
            ...
            <div class="header_page basic background_image colored_bg" style="background-image:url();background-repeat: no-repeat;background:#f6f6f6; -webkit-background-size: cover;-moz-background-size: cover;-o-background-size: cover;background-size: cover; color:#2f383d; ">
                <div class="container">
                    ...
                    <h1 class=" portfolio_big_title">{{$video->titulo}}</h1>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="span9">
                        <article id="post-3049" class="post-3049 post type-post status-publish format-standard has-post-thumbnail hentry category-new blog-article v1 normal">
                            <div class="media">
                                <iframe  height="450" src="http://www.youtube.com/embed/{{$video->video}}?autoplay=0"></iframe>
                            </div>
                        </article>
                        ...
                        <div id="widget_flickr-2" class="widget widget_flickr">
                            <h5 class="widget-title">Otros videos</h5>
                            <div class="flickr_container">
                                 ...
                                 <table  class="scroll">
                                    ...
                                    <tr>
                                        ...
                                        <td> <p><a href="{{url('verVideo/'.$video->idvideo)}}">{{substr($video->titulo,0,21)}}...</a></p></td>
                                    </tr>
                                    <tr>
                                        <td><a href="{{url('verVideo/'.$video->idvideo)}}"><img src="http://img.youtube.com/vi/{{$video->video}}/maxresdefault.jpg" alt=""></a></td>
                                    </tr>
                                    @endforeach
                                 </table>

...
<div class="top_wrapper   no-transparent">
    <div class="header_page basic background_image colored_bg" style="background-image:url();background-repeat: no-repeat;background:#f6f6f6; -webkit-background-size: cover;-moz-background-size: cover;-o-background-size: cover;background-size: cover; color:#2f383d; ">
        <div class="container">
            ...
            <h1 class=" portfolio_big_title">Resultados para "{{$buscado}}"</h1>
        </div>
    </div>
    <section id="content" class="composer_content">
        <div id="fws_556d7a50326a2" class="wpb_row animate_onoffset  vc_row-fluid  animate_onoffset row-dynamic-el standard_section    " style="padding-top: 0px !important; padding-bottom: 0px !important; ">
                                ...
                                <div class="row">
                                    <div class="caroufredsel_wrapper" >
                                        <div class="caroufredsel_wrapper" >
                                            ...
                                            <div class="news-carousel-item" style="margin-right: 0px;">
                                                <dl class="news-article blog-article dl-horizontal">
                                                    <dt><img src="{{$producto->imagen}}" alt=""></dt>
                                                    <dd>
                                                        <h5><a href="{{url('verProducto/'.$producto->idproducto.'/'.str_replace(' ','-',$producto->nombre))}}">{{$producto->nombre}}</a></h5>
                                                        <div class="blog-content">{{$producto->descripcionCorta}}</div>
                                                        <div class="read_more"><a href="{{url('verProducto/'.$producto->idproducto.'/'.str_replace(' ','-',$producto->nombre))}}">ir al producto</a></div>
                                                    </dd>
                                                </dl>
                                            </div>
                                            @endforeach
                                            ...
                                            <div class="news-carousel-item" style="margin-right: 0px;">
                                                <dl class="news-article blog-article dl-horizontal">
                                                    <dt><img src="{{$empresa->imagen}}" alt=""></dt>
                                                    <dd>
                                                        <h5><a href="{{url('Marcas?marca='.$empresa->idempresa)}}">{{$empresa->descripcion}}</a></h5>
                                                        <div class="blog-content">{{$empresa->descripcion}}</div>
                                                        <div class="read_more"><a href="{{url('Marcas?marca='.$empresa->idempresa)}}">ver empresa</a></div>
                                                    </dd>
                                                </dl>
                                            </div>
                                            @endforeach

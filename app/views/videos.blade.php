        ...
        <div class="top_wrapper   no-transparent">
            <div class="header_page basic background_image colored_bg" style="background-image:url();background-repeat: no-repeat;background:#f6f6f6; -webkit-background-size: cover;-moz-background-size: cover;-o-background-size: cover;background-size: cover; color:#2f383d; ">
                <div class="container">
                    ...
                    <h1 class=" portfolio_big_title">Videos</h1>
                </div>
            </div>
                       <section id="content" class="normal" >
             <div class="container" id="blog">
             <div class="row">
           <div class="span12" style="background-color:#EDEDED; ">
            @foreach($videos as $video)
                            ...
                            <article id="post-3049" class="post-3049 post type-post status-publish format-standard has-post-thumbnail hentry category-new row-fluid blog-article v2 normal">
                                <div class="span12">
                                    <div class="span3">
                                        <div class="me style="background-color:#EDEDED; "dia"><br>
                                            <a href="{{url('verVideo/'.$video->idvideo)}}"><img src="http://img.youtube.com/vi/{{$video->video}}/maxresdefault.jpg" alt=""></a>
                                        </div>
                                    </div>
                                    <div class="span6">
                                        <div class="content post_format_standart">
                                            <h4><a href="{{url('verVideo/'.$video->idvideo)}}">{{$video->titulo}}</a></h4>
                                            <ul class="info">
                                            <li><i class="linecon-icon-video"></i><a href="https://www.youtube.com/user/agromg123" target="blank">Agromg Haciendo Agronegocios</a></li>
                                            </ul>

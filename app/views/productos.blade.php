  ...
  fjs.parentNode.insertBefore(js, fjs);
    ...
    <!-- Start Top Navigation -->
            ...
            <div class="container">
                ...
                <h1 class=" portfolio_big_title">Productos</h1>
            </div>
        </div>



        <section class="layout-fullsize items-layout-boxed" style="background:#fff;">
            <div class="container" style="background-color:#EDEDED; ">
                <div class="row-fluid">
                </div>
                <div class="row-fluid">
                    <section id="portfolio-preview-items" class="three-cols span12" data-nr="">
                        <div class="row ">
                            <!-- Portfolio Normal Mode -->
                            <!-- item -->
                             @foreach($familias as $familia)
                             <a href="#" class="contenerdor" id="{{$familia->idfamilia}}"> 
                            <div class="portfolio-item ">
                                <div  class="he-wrap tpl2">
                                     ...
                                     <div class="overlay he-view">
                                        <div class="bg a0" >
                                            <div class="center-bar v1">
                                                <p class="title a1 lightbox-gallery lightbox" data-animate="fadeInUp">{{$familia->descripcion}}</p>
                                 ...
                                 <div class="info">
                                    <b><p><a href="#" onclick="verFamilia({{$familia->idfamilia}})">{{$familia->descripcion}}</a></p></b>
                                   
                                </div>
                            </div>
                            </a>
                            <?php $totalfamilias=$familia->idfamilia;?>
                            @endforeach
                            <input type="hidden" id="totalFamilias" value="{{$totalfamilias}}">
         ...
         @foreach($familias as $familia) 
         <div id="familia{{$familia->idfamilia}}" class="wpb_row animate_onoffset  vc_row-fluid  animate_onoffset row-dynamic-el section-style    " style="padding-top: 0px !important; padding-bottom: 90px !important; display:none;">
                                ...
                                <div class="vc_col-sm-12 wpb_column column_container" style="" data-animation="" data-delay="0">
                                    <div class="wpb_wrapper">
                                        <div class="dark_clients clients_el ">
                                            <div class="header">
                                                <h2>{{$familia->descripcion}}</h2></div>
                                                <section id="portfolio-preview-items" class="four-cols span12" data-nr="6">
                        <div class="row filterable">
                            <!-- Portfolio Normal Mode -->
                            <!-- item -->
                            <?php 
                            $productos=Producto::where("familia",'like', '%'.$familia->idfamilia.'%')->get();
                            ?>
                            ...
                            <div align="right"><h3>{{$productos->count()}} productos en total</h3></div>
                        </div>
            ...
            <!-- widget -->
                ...
                <div class="span3">
                    ...
                    <div id="widget_contact_info-2" class="widget widget_contact_info">
                        ...
                        <ul>
                            <li class="youtube"><a href="https://www.youtube.com/user/agromg123" target="_blank"><img width="25" height="25" src="{{url('img/1.png')}}">Haciendo agronegocios</a></li>
                                                <li class="twitter"><a href="https://twitter.com/agromg" target="_blank"><img width="25" height="25" src="{{url('img/2.png')}}">@AGROMG</a></li>
                                                <li class="facebook"><a href="https://www.facebook.com/Campo-Competitivo-AgrOMG-214899215376460/?ref=hl" target="_blank"><img width="25" height="25" src="{{url('img/3.png')}}">Haciendo agronegocios</a></li>

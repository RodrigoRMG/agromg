  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Agregar funcion</h4>
      </div>
      <div class="modal-body">
        
            <div class="form-group">
                <label>Descripción de la funcion</label>
      ...
      <div class="modal-footer">
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><i class="fa fa-folder"></i> Función</h1>
                        <h1 align="right"><a href="" class="btn btn-primary" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus"></i> Agregar función</a></h1><br>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                    ...
                    <div class="col-lg-12 col-md-6">
                       @if (Session::has('mensaje'))
                            ...
                            <div class="alert alert-danger">
                                La categoría no pudo ser guardada
                            </div>
                            @endif
                            @endif
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="col-md-2">
                                    <a class="btn btn-danger" href="eliminarFuncion?idFuncion={{$funcion->idfuncion}}" onClick="return preguntar()"><i class="fa fa-times"></i></a> <a onClick="return borrarDatos()" data-toggle="modal"  data-target="#modificarModal" href="{{url('Admin/modificarFuncion/'.$funcion->idfuncion)}}" class="btn btn-success"><i class="fa fa-pencil"></i></a>
                                </td>
                         </tr>
                            @endforeach

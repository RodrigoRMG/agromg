        ...
        <div class="modal-content">
          ...
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
              &times;</button>
              <h4 class="modal-title">Modificar subcategoría </h4>
            </div>
      ...
      <div class="modal-footer">
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><i class="fa fa-folder-open"></i> Subcategorías</h1>
                        <h1 align="right"><a class="btn btn-primary" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus"></i> Agregar Subcategoría</a></h1><br>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                    ...
                    <div class="col-lg-12 col-md-6">
                       @if (Session::has('mensaje'))
                            ...
                            <div class="alert alert-danger">
                                La subcategoría no pudo ser guardada
                            </div>
                            @endif
                            @endif
                        ...
                        <tbody>
                           @foreach($subcategorias as $subcategoria)
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-danger" <a class="btn btn-danger" href="eliminarSubcategoria?idSubcategoria={{$subcategoria->idSubcategoria}}" onClick="return preguntar()"><i class="fa fa-times"></i></a> <a onClick="return borrarDatos()" data-toggle="modal"  data-target="#modificarModal" href="{{url('Admin/modificarSubcategoria/'.$subcategoria->idSubcategoria)}}" class="btn btn-success"><i class="fa fa-pencil"></i></a>
                                </td>
                         </tr>
                            @endforeach
                            @if($subcategorias->count()==0)
                            <tr><td colspan="3">No hay subcategorías registradas</td></tr>
                            @endif
                     </tbody>
                     </table>
                 </div>

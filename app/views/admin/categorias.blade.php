      ...
      <div class="modal-footer">
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><i class="fa fa-folder"></i> Categorías</h1>
                        <h1 align="right"><a href="" class="btn btn-primary" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus"></i> Agregar Categoría</a></h1><br>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                       ...
                       @if (Session::has('mensaje'))
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="col-md-2">
                                    <a class="btn btn-danger" href="eliminarCategoria?idCategoria={{$categoria->idcategoria}}" onClick="return preguntar()"><i class="fa fa-times"></i></a> <a onClick="return borrarDatos()" data-toggle="modal"  data-target="#modificarModal" href="{{url('Admin/modificarCategoria/'.$categoria->idcategoria)}}" class="btn btn-success"><i class="fa fa-pencil"></i></a>
                                </td>
                         </tr>
                            @endforeach

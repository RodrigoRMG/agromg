      ...
      <div class="modal-footer">
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><i class="fa fa-file-picture-o"></i> Galería</h1>
                        <h4>Alto predeterminado de 350px</h4>
                        <h1 align="right"><a class="btn btn-primary" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus"></i> Agregar Imagen</a></h1><br>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                    ...
                    <div class="col-lg-12 col-md-6">
                      @if (Session::has('mensaje'))
                            ...
                            <div class="alert alert-danger">
                                La imagen no pudo ser guardado
                            </div>
                            @endif
                            @endif
                        ...
                        <tbody>
                           @foreach($imagenes as $imagen)
                            <tr>
                                ...
                                <td  class="col-md-1">
                                    <a href="{{$imagen->imagen}}"  target="_blank"><img src="{{$imagen->imagen}}" width="100" height="56" alt="" title=""></a>
                                </td>
                                <td  class="col-md-2">
                                    {{$imagen->descripcion}}
                                </td>
                                <td class="col-md-2">
                                    <a class="btn btn-danger" <a class="btn btn-danger" href="eliminarImagen/{{$imagen->idImagen}}" onClick="return preguntar()"><i class="fa fa-times"></i></a> 
                                </td>
                         </tr>
                            @endforeach
                            @if($imagenes->count()==0)
                            <tr><td colspan="4">No hay imagenes registradas</td></tr>
                            @endif
                     </tbody>
                     </table>
                 </div>

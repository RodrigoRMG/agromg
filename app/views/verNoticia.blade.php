                ...
                <div class="row">
                    <div class="span9">
                        <div class="posts_here">
                            <article id="post-3046" class="post-3046 post type-post status-publish format-standard has-post-thumbnail hentry category-new tag-premium tag-theme tag-wp-theme blog-article v1 normal">
                                <div class="media">
                                ...
                                <div class="content post_format_standart">
                                            ...
                                            <div class="blog-content" style="color:#000;">
                              ...
                              <?php $otras=Noticia::where('tipoNoticia','=',$noticia->tipoNoticia)->where('idnoticia','<>',$noticia->idnoticia)->take(4)->get();?>
                            @if($otras->count()!=0)
                            <aside class="span3 sidebar" id="widgetarea-sidebar">
                              
                                <div id="recent-posts-2" class="widget widget_recent_entries">
                                    <h5 class="widget-title">Otras</h5>
                                    <ul>
                                      
                                        @foreach($otras as$otra)
                                        <li>
                                            <a href="{{url('verNoticia/'.$otra->idnoticia)}}">{{$otra->titulo}}</a>
                                        </li>
                                        @endforeach

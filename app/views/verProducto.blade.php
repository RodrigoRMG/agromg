...
<head>
    ...
    setTimeout(function() {document.getElementById('imagen'+id).src=img;},125);
}
function changeImage2(img,id){
    // document.getElementById('bigImage').src=img;
    setTimeout(function() {document.getElementById('imagen'+id).src=img;},125);
}
                            </script>
  ...
  <!-- Start Top Navigation -->
        ...
        <div class="top_wrapper   no-transparent">
            ...
            <section id="content" class="composer_content">
                <div id="fws_556c494487763" class="wpb_row animate_onoffset  vc_row-fluid  animate_onoffset row-dynamic-el section-style    " style="padding-top: 80px !important; padding-bottom: 40px !important; ">
                    <div class="container  dark">
                        <div class="section_clear">
                           <div class="vc_col-sm-6" style="" data-animation="" data-delay="0">
                            <div class="">
                                <div class="header " style="">
                                    ...
                                    @if($producto->video!="")
                                        ...
                                        <div class="wpb_content_element block_skill">
                                            ...
                                            src="http://www.youtube.com/embed/{{$producto->video}}?autoplay=0">
                                        </iframe>
                                        </div>
                                        @endif
                                </div>
                            ...
                            <div class="vc_col-sm-6 wpb_column column_container" style="" data-animation="" data-delay="0">
                                <div class="wpb_wrapper">
                                    <div class="wpb_content_element">
                                        <div class="one-staff">
                                            <div class="img_staff"><img src="{{$producto->imagen}}" alt=""></div>
                ...
                <div id="fws_556c49448b8cf" class="wpb_row animate_onoffset  vc_row-fluid  animate_onoffset row-dynamic-el section-style    " style="padding-top: 60px !important; padding-bottom: 60px !important; ">
                    <div class="container  dark">
                        <div class="section_clear">
                    ...
                    <div id="fws_556c494490dc4" class="wpb_row animate_onoffset  vc_row-fluid  animate_onoffset row-dynamic-el section-style    " style="padding-top: 0px !important; padding-bottom: 90px !important; ">
                        <div class="container  dark">
                            <div class="section_clear">

                                <?php $relacionados=Producto::where('empresa','=',$producto->empresa)->orderByRaw("RAND()")->take(4)->get();?>
                                ...
                                <div class="vc_col-sm-3 wpb_column column_container" style="" data-animation="" data-delay="0">
                                    <div class="wpb_wrapper">
                                        <div class="wpb_content_element">
                                            <div class="one-staff">
                                                <div class="img_staff"><a href="{{url('verProducto/'.$relacionado->idproducto.'/'.str_replace(' ','-',$relacionado->nombre))}}"><img src="{{$relacionado->imagen}}" alt=""></a></div>
                                                <div class="content ">
                                                    <a href="{{url('verProducto/'.$relacionado->idproducto.'/'.str_replace(' ','-',$relacionado->nombre))}}"><h6>{{$relacionado->nombre}}</h6></a>
                                                </div>
                    ...
                    <div id="fws_5565d3934070e" class="wpb_row animate_onoffset  vc_row-fluid  animate_onoffset row-dynamic-el section-style    " style="padding-top: 0px !important; padding-bottom: 90px !important; ">
                        <div class="container  dark">
                            <div class="section_clear">
                                <div class="vc_col-sm-12 wpb_column column_container" style="" data-animation="" data-delay="0">
                                    <div class="wpb_wrapper">
                        ...
                        <div class="row filterable">
                            ...
                            <div class="portfolio-item v1" >
                                <div class="he-wrap tpl2">
                                    <a href="{{url('Marcas?marca='.$empresa->idempresa)}}"><img id="imagen{{$empresa->idempresa}}" src="{{$empresa->imagen}}" onmouseleave="changeImage2('{{$empresa->imagen}}','{{$empresa->idempresa}}')" onmouseover="changeImage('{{$empresa->imagenOver}}','{{$empresa->idempresa}}')"></a>

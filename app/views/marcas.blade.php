  ...
  fjs.parentNode.insertBefore(js, fjs);
    ...
    <!-- Start Top Navigation -->
            ...
            <div class="container">
                ...
                <h1 class=" portfolio_big_title">{{$empresa->descripcion}}</h1>
            </div>
        </div>
        ...
        <section class="layout-fullsize items-layout-boxed" style="background:#fff;">
                    ...
                    <section id="portfolio-preview-items" class="four-cols span12" data-nr="4">
                        <div class="row">
                            ...
                            <div class="portfolio-item v1" >
                                ...
                                <div class="info">
                                    <p><b><a href="{{url('verProducto/'.$producto->idproducto.'/'.str_replace(' ','-',$producto->nombre))}}">{{$producto->nombre}}</a></b></p>
                                    <font color="black">{{substr(strip_tags(trim($producto->descripcionCorta)),0,100)}}...</font>
            ...
            <div class="container">
                ...
                <h1 class=" portfolio_big_title">Nuestras marcas</h1>
            </div>
        </div>



        <section class="layout-fullsize items-layout-boxed" >
                    ...
                    <section id="portfolio-preview-items" class="four-cols span12" data-nr="6">
                        <div class="row ">
                            ...
                            <div class="portfolio-item v1" >
                                ...
                                <div class="info">
                                    <h3><a href="{{url('Marcas?marca='.$empresa->idempresa)}}">{{$empresa->descripcion}}</a></h3>
